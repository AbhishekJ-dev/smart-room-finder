  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative bg-white w-full max-w-md rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] overflow-hidden z-10"
      ...
      >
        <div className="p-6 sm:p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <button
              onClick={onClose}
              className="p-2.5 bg-[#f9fafb] text-[#6b7280] rounded-2xl hover:bg-[#f3f4f6] hover:text-[#111827] transition-all cursor-pointer"
            >
              <X size={18} />
            </button>
          </div>
